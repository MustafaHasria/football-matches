...
class LineupsUi extends StatefulWidget {
  ...
  const LineupsUi(
      this.fixtureId, this.homeScore, this.awayScore, this.hour, this.date,
      {Key? key})
      : super(key: key);
  final int? fixtureId;
  final int? homeScore;
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Column(
                        children: [
                          CachedNetworkImage(
                            imageUrl: state.data.getHomeLogo() ?? "",
                            width: 48,
                            height: 40,
                          ),
                          const SizedBox(
                          ...
                          const Text(
                            "Home",
                            style: TextStyle(
                                fontSize: 12, color: AppColors.greyLine),
                          ),
                        ],
                      ),
                      ...
                      Column(
                        children: [
                          CachedNetworkImage(
                            imageUrl: state.data.getAwayLogo() ?? "",
                            width: 48,
                            height: 40,
                          ),
                          const SizedBox(
                  ...
                  Container(
                    ...
                    height: 1,
                    margin:
                        const EdgeInsetsDirectional.only(top: 16, bottom: 4),
                  ...
                  Court(
                      state.data.getHomePlayers(),
                      state.data.getAwayPlayers(),
