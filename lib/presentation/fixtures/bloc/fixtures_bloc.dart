...
class FixturesBloc extends Bloc<FixturesEvent, FixturesState> {
      ...
      if (event is GetFixturesEvent) {
        ...
        switch (response.responseType) {
          case ResponseType.success:
            List<IFinishedGame> finishedGames =
                getFinishedGames(response.response);
            List<IUpcomingGame> upcomingGames =
                getUpcomingGames(response.response);
  ...
  List<IFinishedGame> getFinishedGames(List<FixtureItem>? allGames) {
    ...
    List<FixtureItem>? filtered = allGames
        ?.where((element) => isSmallerThanCurrentTime(element.fixture?.date))
        .toList();
